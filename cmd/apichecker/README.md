...
[![GoDoc](https://godoc.org/github.com/otter-trade/coin-exchange-api?status.svg)](https://godoc.org/github.com/otter-trade/coin-exchange-api/cmd/apichecker)
...
```bash
git clone https://github.com/otter-trade/coin-exchange-api.git
