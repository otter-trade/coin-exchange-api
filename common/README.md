...
[![GoDoc](https://godoc.org/github.com/otter-trade/coin-exchange-api?status.svg)](https://godoc.org/github.com/otter-trade/coin-exchange-api/common)
...
```go
import "github.com/otter-trade/coin-exchange-api/common"
