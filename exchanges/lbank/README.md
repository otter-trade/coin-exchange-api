...
[![GoDoc](https://godoc.org/github.com/otter-trade/coin-exchange-api?status.svg)](https://godoc.org/github.com/otter-trade/coin-exchange-api/exchanges/lbank)
...
+ [Enable via configuration](https://githul.com/otter-trade/coin-exchange-api/tree/master/config#enable-exchange-via-config-example)
