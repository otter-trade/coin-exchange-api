...
[![GoDoc](https://godoc.org/github.com/otter-trade/coin-exchange-api?status.svg)](https://godoc.org/github.com/otter-trade/coin-exchange-api/config)
...
```sh
cd ~/go/src/github.com/otter-trade/coin-exchange-api
