...
import (
	...
	gctlog "github.com/otter-trade/coin-exchange-api/log"
	"github.com/otter-trade/coin-exchange-api/portfolio/withdraw"
	"github.com/otter-trade/coin-exchange-api/utils"
)
...
func (bot *Engine) Start() error {
	...
	if bot.Settings.EnableEventManager {
		if e, err := setupEventManager(bot.ExchangeManager, bot.Settings.EventManagerDelay, bot.Settings.EnableDryRun); err != nil {
...
func (bot *Engine) RegisterWebsocketDataHandler(fn WebsocketDataHandler, interceptorOnly bool) error {
	if bot == nil {
		return errors.New("received nil engine bot")
	}
