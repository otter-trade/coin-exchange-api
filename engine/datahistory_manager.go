...
import (
	...
	gctmath "github.com/otter-trade/coin-exchange-api/common/math"
	...
	"github.com/otter-trade/coin-exchange-api/database/repository/datahistoryjob"
	"github.com/otter-trade/coin-exchange-api/database/repository/datahistoryjobresult"
...
func (m *DataHistoryManager) runJobs() error {
	...
	if !atomic.CompareAndSwapInt32(&m.processing, 0, 1) {
		return fmt.Errorf("cannot process jobs, %w", errors.New("already running"))
	}
